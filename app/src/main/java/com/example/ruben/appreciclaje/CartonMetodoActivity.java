    ...
    public void onClick(View view) {
        ...
        switch(view.getId()) {
            ...
            case R.id.btnImageCarton:
                intent = new Intent(CartonMetodoActivity.this, CartonActivity.class);
                startActivity(intent);
                break;
            case R.id.btnImageVidrio:
                intent = new Intent(CartonMetodoActivity.this, VidrioActivity.class);
                startActivity(intent);
                break;
            case R.id.btnImageMetal:
                intent = new Intent(CartonMetodoActivity.this, MetalActivity.class);
                startActivity(intent);
                break;
            case R.id.btnImageOrganico:
                intent = new Intent(CartonMetodoActivity.this, OrganicoActivity.class);
                startActivity(intent);
                break;
            case R.id.btnImagePlastico:
                intent = new Intent(CartonMetodoActivity.this, PlasticoActivity.class);
                startActivity(intent);
                break;
            case R.id.btnImageBateria:
                intent = new Intent(CartonMetodoActivity.this, BateriaActivity.class);
                startActivity(intent);
                break;
        }
    }
