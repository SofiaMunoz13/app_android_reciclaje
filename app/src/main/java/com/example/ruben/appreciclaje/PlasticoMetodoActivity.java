...
public class PlasticoMetodoActivity extends AppCompatActivity implements View.OnClickListener{
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_plastico_metodo);
        setMenu();
        setContent();
    }
    ...
    public void onClick(View view) {
        ...
        switch(view.getId()){
            case R.id.fab:
                intent=new Intent(PlasticoMetodoActivity.this,MapsActivity.class);
                startActivity(intent);
                break;
            case R.id.btnImageCarton:
                intent = new Intent(PlasticoMetodoActivity.this, CartonActivity.class);
                startActivity(intent);
                break;
            case R.id.btnImageVidrio:
                intent = new Intent(PlasticoMetodoActivity.this, VidrioActivity.class);
                startActivity(intent);
                break;
            case R.id.btnImageMetal:
                intent = new Intent(PlasticoMetodoActivity.this, MetalActivity.class);
                startActivity(intent);
                break;
            case R.id.btnImageOrganico:
                intent = new Intent(PlasticoMetodoActivity.this, OrganicoActivity.class);
                startActivity(intent);
                break;
            case R.id.btnImagePlastico:
                intent = new Intent(PlasticoMetodoActivity.this, PlasticoActivity.class);
                startActivity(intent);
                break;
            case R.id.btnImageBateria:
                intent = new Intent(PlasticoMetodoActivity.this, BateriaActivity.class);
                startActivity(intent);
                break;
        }
    }
